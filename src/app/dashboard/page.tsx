...
import LegalNorms from "@/components/LegalNorms";


export default function Dashboard() {
    const[name, setName] = useState("");
    const[acceptedNorms, setAcceptedNorms] = useState(false);
            ...
            <div className="min-h-screen flex flex-col">
                ...
                <div className="flex flex-1">
                    ...
                    <main className="bg-gray-100 flex-1 p-6">
                        {/* 條款確認機制 - 強制彈出 */}
                        {!acceptedNorms && <LegalNorms onAccept={() => setAcceptedNorms(true)} />}
                        {acceptedNorms && (
